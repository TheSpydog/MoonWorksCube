...
public class MainState : MoonWorks.GameState
{
	...
	public override void Update(System.TimeSpan dt) { }

	public override void Draw(System.TimeSpan dt, double alpha)
	{
		Matrix4x4 proj = Matrix4x4.CreatePerspectiveFieldOfView(MoonWorks.Math.MathHelper.ToRadians(75f), (float)Window.Width / Window.Height, 0.01f, 100f);
